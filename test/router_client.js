...
Tinytest.add('Router i18n - test setMatchingLanguage', function (test) {
    ...
    router.setMatchingLanguage('es-AR');
    test.equal(router.getLanguage(), 'es');

    router.setMatchingLanguage('es_AR');
    test.equal(router.getLanguage(), 'es');

    router.setMatchingLanguage('ES_AR');
    test.equal(router.getLanguage(), 'es');

    router.setMatchingLanguage('ES-CH');
    test.equal(router.getLanguage(), 'es-ch');

    router.setMatchingLanguage('it');
    test.equal(router.getLanguage(), 'it');
