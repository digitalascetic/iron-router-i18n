...
initi18n = function (options) {
    ...
    if (!this.options.i18n.i18nConf || !I18NConf) {
    ...
    if (!I18NConf || !this.options.i18n.i18nConf) {
        this._i18n.onLanguageChange = function (lang) {
...
Meteor.startup(function () {
    ...
    if ((!Router.options.i18n.i18nConf || !I18NConf)
        && (!Router.options.i18n.persistLanguage || !Router.options.i18n.persistLanguage())
        && Router.options.i18n.autoConfLanguage) {
