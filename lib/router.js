...
//I18NRouter = Iron.Router.constructor;

I18NRouter.prototype = new Iron.Router;
...
I18NRouter.prototype.configure = function (options) {
    ...
    _.extend(this.options.i18n, i18nDefaults.hooks);
...
I18NRouter.prototype.route = function (path, fn, opts) {
    ...
    for (var lang in configuredLanguageRoutes) {
        ...
        var newRoute = superRoute.apply(this, [route.name + '_' + lang, i18n_options]);
        newRoute._i18n = {};
...
/*
 ...
 I18NRouter.prototype._i18n.languageDep = new Deps.Dependency();
 */
