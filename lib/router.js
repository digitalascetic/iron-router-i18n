...
// Weak dependency, must check existence in Package global
var I18NConf = Package['martino:i18n-conf'] ? Package['martino:i18n-conf'].I18NConf : null;
...
configurei18n = function (options) {
     ...
     */
    if (I18NConf && this.options.i18n.i18nConf && this._i18n.firstConfigure) {
        ...
        I18NConf.onLanguageChange(function (oldLang, newLang) {
            ...
            self._i18n.language = newLang;

            self._i18n.isLanguageSet = true;

            if (_.isFunction(self.options.i18n.setLangCode)) {
        ...
        // This will be handled by i18n-conf
        this.options.i18n.autoConfLanguage = false;
        this.options.i18n.persistLanguage = false;
...
Router.route = function (path, fn, opts) {
    ...
    route.origRoute = this.options.i18n.langCodeForDefaultLanguage ? origRoute : route;
...
Router.setLanguage = function (lang) {
    ...
    if (this.options.i18n.persistLanguage) {
        this.options.i18n.persistLanguage.call(this, lang);
    }
    ...
    if (this.options.i18n.setLangCode && this.current() && this.current().route) {
        this.options.i18n.setLangCode.call(this, lang);
    }

    if (I18NConf && this.options.i18n.i18nConf) {
        I18NConf.setLanguage(lang);
    }

    // Client or server specific language change actions
    if (this._i18n.onLanguageChange) {
        this._i18n.onLanguageChange.call(this, lang);
    }
...
Router.getLanguage = function () {
    ...
    if (I18NConf && this.options.i18n.i18nConf) {
        return I18NConf.getLanguage();
    }

    var lang = null;

    if (this.options.i18n.persistLanguage) {
        lang = this.options.i18n.persistLanguage.call(this);
        if (lang) {
            return lang;
        }
    }
