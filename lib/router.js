...
var superFindFirstRoute = I18NRouter.prototype.findFirstRoute;
...
I18NRouter.prototype.route = function (path, fn, opts) {
    ...
    if (opts && opts.i18n && opts.i18n.languages) {
        ...
        routeLanguages = opts.i18n.limitToSpecified ? _.keys(configuredLanguageRoutes) : _.difference(routerLanguages, [defaultLanguage]);
    } else {
