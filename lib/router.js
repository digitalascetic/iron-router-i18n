...
I18NRouter.prototype.route = function (path, fn, opts) {
    ...
    console.log(route.handler.where);
    console.log(opts);
    ...
    for (var lang in configuredLanguageRoutes) {
        ...
        var newRoute = superRoute.call(this, route.getName() + '_' + lang, i18n_options);
        newRoute._i18n = {};
...
I18NRouter.prototype.dispatch = function (url, context, done) {
    ...
    if (!langCode) {
        ...
        if (this.options.i18n.rewritePath) {
            ...
            url = this.options.i18n.rewritePath.call(this, url, this.options);
        }
