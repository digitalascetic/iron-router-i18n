        ...
        hooks: {
            ...
            langCodeAction: function (langCode) {
                ...
                if (lang) {
                    ...
                    if (langCode != lang || !I18NConf.isLanguageSet) {
...
Router._createDeferredRoutes = function () {
    var defRoutesCount = this._i18n.deferredRoutes.length;
    for (var n = 0; n < defRoutesCount; n++) {
        var defRoute = this._i18n.deferredRoutes[n];
        defRoute.opts = defRoute.opts || {};
        defRoute.opts.createRoute = true;
        this.route(defRoute.path, defRoute.fn, defRoute.opts);
    }
    this._i18n.deferredRoutes = [];
};
...
Router.route = function (path, fn, opts) {
    ...
    if (opts.deferRouteCreation ||
        (this.options.i18n.deferRouteCreation && !opts.createRoute)) {
        this._i18n.deferredRoutes.push({path: path, fn: fn, opts: opts});
        return;
    }
...
Iron.Router.prototype._createDeferredRoutes = Router._createDeferredRoutes;
