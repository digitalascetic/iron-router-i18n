...
configurei18n = function (options) {
    ...
    if (_.isObject(I18NConf) && this.options.i18n.i18nConf && this._i18n.firstConfigure) {
        ...
        this.options.autoConfLanguage = false;
        this.options.persistLanguage = false;
...
Router.setLanguage = function (lang) {
    ...
    // Avoid infinite loop with I18NConf
    if (this._i18n.settingLanguage) {
        this._i18n.settingLanguage = false;
        return;
    }

    this._i18n.settingLanguage = true;
