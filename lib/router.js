...
configurei18n = function (options) {
        ...
        hooks: {
            ...
            langCodeAction: function (langCode) {
                ...
                if (lang) {
                    ...
                    if (!this._i18n.settingLanguage && (langCode != lang || !this.isLanguageSet())) {
     ...
     */
    if (_.isObject(I18NConf) && this.options.i18n.i18nConf && this._i18n.firstConfigure) {
...
Router.setLanguage = function (lang) {
    ...
    if (_.isObject(I18NConf) && this.options.i18n.i18nConf) {
