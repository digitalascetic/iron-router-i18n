(function () {
    ...
    _.extend(Router, {
            ...
            hooks: {
                ...
                getLangCode: function (path, options) {
                    ...
                    if (languages) {
                        ...
                        console.log("Router config options i18n.languages is compulsory");
                        langCode = null;
                    }
                    return langCode;
                },
        ...
        match: function(path) {
            if (!Router.routeIsName && this.options.i18n.rewritePath) {
                path = this.options.i18n.rewritePath(path, this.options);
            }
            return origMatch.apply(this, [path]);
        },
